  ...
  <div style="max-width:600px; width:100%; margin:0 auto; box-sizing:border-box; margin-bottom:20px; ">
    <div style="width:100%; float:left; background:#fff;box-sizing:border-box; border:1px solid #ddd;">
      ...
      <div style="width:100%; float:left;">
        <h1 style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold; text-align:center; line-height:30px; color:#37a0c9;">Approved Account</h1>
      ...
      <div style="width:100%; float:left;">
        ...
        <table style="width:91%; margin:0 auto;">
          <tr style="background-color: #e3e3e3;">
            ...
            <td style="width:70%;padding:10px"><?php echo (isset($data['username']) && $data['username'] != "") ? $data['username'] : '';  ?></td>
          </tr>
          <tr style=" background-color: #d9d9d9;">
            <td style="width:30%;padding:10px"><strong> Email </strong></td>
            <td style="width:30%;padding:10px"><?php echo (isset($data['email_address']) && $data['email_address'] != "") ? $data['email_address'] : '';  ?></td>
          </tr>
          <tr style=" background-color: #d9d9d9;">
            <td style="width:30%;padding:10px"><strong> Status </strong></td>
            <td style="width:30%;padding:10px">Approved</td>
          </tr>
          <tr style=" background-color: #d9d9d9;">
            <td style="width:100%;padding:10px"><a href="<?php echo (isset($data['url']) && $data['url'] != "") ? $data['url'] : '';  ?>  target=" _blank">Click Here</a></td>
          </tr>
        </table>
